    ...
    try {
      ...
      if (cached) {
        try {
          ...
          setErrorMessage("Showing cached sessions because the latest data could not be loaded.");
          return;
        } catch (cacheError) {
        ...
        {sessions.length > 0 ? (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-gray-500 mt-1 truncate max-w-xl">
                    {session.description ||
                      "Algorithmic logic blueprint generated by AI."}
                  </p>
                </div>
          ...
          <div className="text-center py-20 opacity-40">
            ...
            <p className="text-gray-400 font-bold uppercase tracking-widest text-sm">
              No neural blueprints found
            </p>
            <p className="text-[10px] text-gray-600 mt-2 uppercase tracking-[0.2em]">
              Start a new session to build your algorithmic core.
            </p>
          </div>
        )}
      </Motion.div>
